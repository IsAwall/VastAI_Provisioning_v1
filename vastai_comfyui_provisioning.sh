...
# Use ComfyUI's OWN python/pip. ai-dock provides these helpers and variables;
# we fall back to plain pip/python if they aren't present (e.g. local testing).
...
install_node() {
    ...
    # This is the part that a fresh /opt environment loses:
